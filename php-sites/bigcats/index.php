                ...
                <div class="row">
                    ...
                    <!--<h3>Six Column Section</h3>-->
                        ...
                        <div class="col-md-2" id="col2">
                            <h3>CHEETAH</h3>
                            <!--<h5>Left</h5>-->
                            <img src="img/cheetah_5.jpg" alt=""/><br>
                        ...
                        <div class="col-md-2" id="col4">
                            <h3>JAGUAR</h3>
                            <!--<h5>R Middle</h5>--> 
                            <img src="img/jaguar_6.jpg" alt=""/></br>
                        ...
                        <div class="col-md-2" id="col5">
                            <h3>LEOPARD</h3>
                            <!--<h5>Right</h5>-->
                            <img src="img/leopard_4.jpg" alt=""/></br>

...
<html lang="en">
    ...
    <body> 
            ...
            <nav class="navbar navbar-custom" data-spy="affix" data-offset-top="-5">
                <div class="container-fluid">
                    <div class="navbar-header">
                        <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navi" aria-expanded="false" id="aNavi">
                        ...
                        <a href="" class="navbar-brand"><i class="fa fa-camera" aria-hidden="true"></i> Big Cats</a>                        
                    </div>
                    <div class="collapse navbar-collapse" id="navi">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="">HOME <i class="fa fa-home" aria-hidden="true"></i></a></li>
                        <li><a href="">OFFER <i class="fa fa-gift" aria-hidden="true"></i></a></li>
                        <li><a href="">ACTIVITIES <i class="fa fa-cog" aria-hidden="true"></i></a></li>
                        <li><a href="">SCENE <i class="fa fa-play" aria-hidden="true"></i></a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="hero-text text-center">
                        <h2>an inside look into the world<br> of big cats</h2>
        ...
        <section class="carousel-section text-center text-uppercase">
            <div class="container-fluid">
                <div class="row">                    
                        <h3>Carousel</h3>                  
        ...
        <section class="six-column text-center text-uppercase">
            <div class="container-fluid">
                <div class="row">
                    <h3>Six Column Section</h3>
                        <div class="col-md-2" id="col1">
                            <h5>F Left</h5>
                            <img src="img/lion.jpg" alt=""/><br>
                            <!--<button id="btn" onclick="myFunction(0)">Info <i class="fa fa-angle-down"></i></button>-->
                            <button data-no="0" class="cat" id="animal0">Info <i class="fa fa-angle-down"></i></button>
                            <div id="animal0-info"></div>
                        </div>  
                        <div class="col-md-2" id="col2">
                            <h5>Left</h5>
                            <img src="img/cheetah.jpg" alt=""/><br>
                            <!--<button id="btn" onclick="myFunction(1)">Info <i class="fa fa-angle-down"></i></button>-->
                            <button data-no="1" class="cat" id="animal1">Info <i class="fa fa-angle-down"></i></button>
                            <div id="animal1-info"></div>
                        </div> 
                        <div class="col-md-2" id="col3">
                            <h5>L Middle</h5>
                            <img src="img/puma.jpg" alt=""/></br>
                            <!--<button id="btn" onclick="myFunction(2)">Info <i class="fa fa-angle-down"></i></button>-->
                            <button data-no="2" class="cat" id="animal2">Info <i class="fa fa-angle-down"></i></button>
                            <div id="animal2-info"></div>
                        </div> 
                        <div class="col-md-2" id="col4">
                            <h5>R Middle</h5> 
                            <img src="img/ocelot.jpg" alt=""/></br>
                            <!--<button id="btn" onclick="myFunction(3)">Info <i class="fa fa-angle-down"></i></button>-->
                            <button data-no="3" class="cat" id="animal3">Info <i class="fa fa-angle-down"></i></button>
                            <div id="animal3-info"></div>
                        </div> 
                        <div class="col-md-2" id="col5">
                            <h5>Right</h5>
                            <img src="img/ocelot.jpg" alt=""/></br>
                            <!--<button id="btn" onclick="myFunction(4)">Info <i class="fa fa-angle-down"></i></button>-->
                            <button data-no="4" class="cat" id="animal4">Info <i class="fa fa-angle-down"></i></button>
                            <div id="animal4-info"></div>
                        </div> 
                        <div class="col-md-2" id="col6">
                            <h5>F Right</h5> 
                            <img src="img/tiger.jpg" alt=""/></br>
                            <!--<button id="btn" onclick="myFunction(5)">Info <i class="fa fa-angle-down"></i></button>-->
                            <button data-no="5" class="cat" id="animal5">Info <i class="fa fa-angle-down"></i></button>
                            <div id="animal5-info"></div>
                        </div> 
                </div>                
            </div>            
        </section>
        ...
        <section class="four-column text-center text-uppercase">
            <div class="container"> 
                <div class="row">
        ...
        <section class="two-column text-center text-uppercase" id="gallery">
            <div class="container">
                <div class="row">                    
                    <h3>Two Column Section</h3>                                       
                        <div class="col-md-8" id="col1">
                            <h5>Left</h5>
                                <div class="gallery">
                                    ...
                                    <a href="img/ocelot.jpg"><img src="img/ocelot.jpg" alt=""/></a>
                                    <a href="img/cheetah_2.jpg"><img src="img/cheetah_2.jpg" alt=""/></a> 
                                    <a href="img/lion.jpg"><img src="img/lion.jpg" alt=""/></a>
                                    <a href="img/puma.jpg"><img src="img/puma.jpg" alt=""/></a>
                                    <a href="img/cheetah.jpg"><img src="img/cheetah.jpg" alt=""/></a>-->
                                    <?php
                                        $search_dir = "img/";
                ...
                <div class="row">                    
                    <h3>One Column Section</h3>                                       
                        <div class="col-md-12" id="col1">
                           ...
                           <button id="btn1"><i class="fa fa-angle-down"></i></button>
                            <div id="lorum-ipsum"></div>
